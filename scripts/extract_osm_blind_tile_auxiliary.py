#!/usr/bin/env python3
"""Extract the candidate-independent stable industrial/grid OSM auxiliary."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="verify cached derivative hashes without rereading the full Planet",
    )
    ...
    summary = {
        ...
        "selected_objects": document.get("selection_statistics", {}).get(
            "selected_objects"
        ),
