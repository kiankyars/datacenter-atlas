#!/usr/bin/env python3
"""Publish or validate the incident-preserving current-coverage ledger v26."""
...
from datacenter_atlas.current_coverage_v26 import (  # noqa: E402
...
def main() -> int:
    ...
    if arguments.validate_only:
        ...
        manifest = validate_current_coverage_ledger_v26()
    else:
        if not arguments.generated_at:
            parser.error("--generated-at is required for first publication")
        manifest = publish_current_coverage_ledger_v26(arguments.generated_at)
    print(
        json.dumps(
            {
                ...
                "rejected_incident": manifest["incident_lineage"]["ledger_id"],
            },
            sort_keys=True,
        )
    )
