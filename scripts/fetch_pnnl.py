#!/usr/bin/env python3
"""Fetch and checkpoint the pinned PNNL/IM3 U.S. GeoPackage artifact."""
...
from datacenter_atlas.pnnl import PNNLIM3Fetcher, PNNL_IM3_USER_AGENT
...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--user-agent", default=PNNL_IM3_USER_AGENT)
    return result


def main(argv: Sequence[str] | None = None) -> int:
    arguments = parser().parse_args(argv)
    manifest = PNNLIM3Fetcher(
