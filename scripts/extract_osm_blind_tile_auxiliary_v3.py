#!/usr/bin/env python3
"""Build or validate the geometry-complete full-Planet OSM auxiliary v3."""
...
from datacenter_atlas import osm_blind_tile_auxiliary_v3 as auxiliary  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    except (auxiliary.OsmBlindTileAuxiliaryV3Error, OSError) as error:
