#!/usr/bin/env python3
"""Publish or validate the immutable v73/federation-v33 coverage audit."""
...
from datacenter_atlas.coverage_audit_v29 import (  # noqa: E402
...
def main() -> int:
    ...
    if arguments.validate_only:
        ...
        audit = validate_coverage_audit_v29()
    else:
        if not arguments.generated_at:
            parser.error("--generated-at is required for first publication")
        audit = publish_coverage_audit_v29(arguments.generated_at)
    print(
        json.dumps(
            {
