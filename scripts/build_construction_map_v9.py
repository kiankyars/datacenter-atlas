#!/usr/bin/env python3
"""Build or offline-validate the immutable v25 construction map."""
...
from datacenter_atlas.construction_map_v9 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v9(
            ...
            manifest = write_construction_map_v9(
    ...
    except ConstructionMapV9Error as error:
        print(f"construction-map-v9 error: {error}", file=sys.stderr)
        return 2
