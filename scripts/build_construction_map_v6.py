#!/usr/bin/env python3
"""Build or offline-validate the immutable v22 construction map."""
...
from datacenter_atlas.construction_map_v6 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v6(
            ...
            manifest = write_construction_map_v6(
    ...
    except ConstructionMapV6Error as error:
        print(f"construction-map-v6 error: {error}", file=sys.stderr)
        return 2
