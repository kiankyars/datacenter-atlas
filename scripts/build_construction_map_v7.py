#!/usr/bin/env python3
"""Build or offline-validate the immutable v23 construction map."""
...
from datacenter_atlas.construction_map_v7 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v7(
            ...
            manifest = write_construction_map_v7(
    ...
    except ConstructionMapV7Error as error:
        print(f"construction-map-v7 error: {error}", file=sys.stderr)
        return 2
