#!/usr/bin/env python3
"""Generate, publish, or offline-validate satellite-change analyst review v4."""
...
from datacenter_atlas.satellite_change_review_v4 import (  # noqa: E402
    DEFINITION_PATH,
    OUTPUT_PATH,
...
def main() -> int:
    ...
    if arguments.emit_definition and arguments.validate_only:
        print(
            "satellite-change-review-v4 error: --emit-definition and "
    ...
    try:
        if arguments.emit_definition:
            ...
            manifest = validate_satellite_change_review_v4(
                arguments.output,
            ...
            manifest = write_satellite_change_review_v4(
    ...
    except SatelliteChangeReviewV4Error as error:
        print(f"satellite-change-review-v4 error: {error}", file=sys.stderr)
        return 2
