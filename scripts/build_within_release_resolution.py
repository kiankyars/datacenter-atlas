#!/usr/bin/env python3
"""Build or validate an immutable within-release resolution-candidate bundle."""
...
from datacenter_atlas.within_release_resolution import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_within_release_resolution(
            ...
            manifest = write_within_release_resolution(
                arguments.definition, arguments.output_dir
            )
    except (OSError, WithinReleaseResolutionError) as error:
        ...
        json.dumps(
            {
                ...
                "manifest_sha256": (
                    arguments.output_dir / "manifest.sha256"
