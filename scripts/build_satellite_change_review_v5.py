#!/usr/bin/env python3
"""Generate, publish, or offline-validate singleton analyst review v5."""
...
from datacenter_atlas.satellite_change_review_v5 import (  # noqa: E402
    DEFINITION_PATH,
    OUTPUT_PATH,
...
def main() -> int:
    ...
    if arguments.emit_definition and arguments.validate_only:
        print(
            "satellite-change-review-v5 error: --emit-definition and "
    ...
    try:
        if arguments.emit_definition:
            ...
            manifest = validate_satellite_change_review_v5(
                arguments.output,
            ...
            manifest = write_satellite_change_review_v5(
    ...
    except SatelliteChangeReviewV5Error as error:
        print(f"satellite-change-review-v5 error: {error}", file=sys.stderr)
        return 2
