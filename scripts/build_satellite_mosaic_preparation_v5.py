#!/usr/bin/env python3
"""Build or validate the publication-mechanics-v5 mosaic preparation release."""
...
from datacenter_atlas.satellite_mosaic_preparation_v5 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            ...
            manifest = write_satellite_mosaic_preparation_v5(
                arguments.output_dir, definition_path=arguments.definition
            )
    except SatelliteMosaicPreparationError as error:
        print(f"satellite-mosaic-preparation-v5 error: {error}", file=sys.stderr)
        return 2
