#!/usr/bin/env python3
"""Build or offline-validate the immutable v24 construction map."""
...
from datacenter_atlas.construction_map_v8 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v8(
            ...
            manifest = write_construction_map_v8(
    ...
    except ConstructionMapV8Error as error:
        print(f"construction-map-v8 error: {error}", file=sys.stderr)
        return 2
