#!/usr/bin/env python3
"""Build v0.8 or validate any supported Verified Construction Core preview."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=CURRENT_V08_PREVIEW_DIR,
        help="preview directory (default: current v0.8 artifact path)",
    )
    parser.add_argument(
        "--validate-only",
        action="store_true",
        help="validate an existing v0.1-v0.8 preview without the ignored source corpus",
    )
