#!/usr/bin/env python3
"""Build v0.9 or validate any supported Verified Construction Core preview."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=CURRENT_V09_PREVIEW_DIR,
        help="preview directory (default: current v0.9 artifact path)",
    )
    parser.add_argument(
        "--validate-only",
        action="store_true",
        help="validate an existing v0.1-v0.9 preview without the ignored source corpus",
    )
