#!/usr/bin/env python3
"""Publish or validate the immutable v71/federation-v31 coverage audit."""
...
def main() -> int:
    ...
    if arguments.validate_only:
        ...
        audit = validate_coverage_audit_v28()
    else:
        if not arguments.generated_at:
            parser.error("--generated-at is required for first publication")
        audit = publish_coverage_audit_v28(arguments.generated_at)
    print(
        json.dumps(
            {
