#!/usr/bin/env python3
"""Publish the exact frozen open-seed v86 satellite-review queue."""
...
from datacenter_atlas.satellite_queue_v86 import (
    QUEUE,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    manifest = publish_satellite_queue_v86(generated_at=arguments.generated_at)
