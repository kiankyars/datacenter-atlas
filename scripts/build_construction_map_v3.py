#!/usr/bin/env python3
"""Build or offline-validate the immutable v17 construction map."""
...
from datacenter_atlas.construction_map_v3 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v3(
            ...
            manifest = write_construction_map_v3(
    ...
    except ConstructionMapV3Error as error:
        print(f"construction-map-v3 error: {error}", file=sys.stderr)
        return 2
