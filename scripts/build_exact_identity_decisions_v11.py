#!/usr/bin/env python3
"""Publish or validate exact-identity v11."""
...
from datacenter_atlas.exact_identity_decisions_v11 import (  # noqa: E402
    BUNDLE,
    DEFINITION,
        ...
        if arguments.validate_only:
            ...
            if arguments.definition != DEFINITION or arguments.output_dir != BUNDLE:
                raise ExactIdentityDecisionError(
                    "identity v11 publication paths are fixed and no-replace"
                )
