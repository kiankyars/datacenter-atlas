#!/usr/bin/env python3
"""Rebuild and validate the frozen open-seed v60 twice offline."""
...
from datacenter_atlas.open_seed_release_v5 import validate_open_seed_release_v5
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    manifest = validate_open_seed_release_v5(
