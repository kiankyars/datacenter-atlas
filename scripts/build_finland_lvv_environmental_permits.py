#!/usr/bin/env python3
"""Build the Finland LVV fail-closed assessment without network access."""
        ...
        json.dumps(
            {
                ...
                "controlled_audit_requests": bundle["assessment"][
                    "retrieval_batch"
                ]["controlled_audit_requests"],
                "release_id": RELEASE_ID,
                "result_bearing_search_requests": bundle["assessment"][
                    "retrieval_batch"
                ]["result_bearing_search_requests"],
                "result_count": bundle["assessment"]["coverage"]["result_count"],
                "source_rows": bundle["assessment"]["atlas_decision"][
