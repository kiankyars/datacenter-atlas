#!/usr/bin/env python3
"""Publish or validate the immutable v86/federation-v35 coverage audit."""
...
from datacenter_atlas.coverage_audit_v31 import (  # noqa: E402
...
def main() -> int:
    ...
    if arguments.validate_only:
        ...
        audit = validate_coverage_audit_v31()
    else:
        if not arguments.generated_at:
            parser.error("--generated-at is required for first publication")
        audit = publish_coverage_audit_v31(arguments.generated_at)
    print(
        json.dumps(
            {
