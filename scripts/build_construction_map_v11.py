#!/usr/bin/env python3
"""Build or offline-validate the immutable v27 construction map."""
...
from datacenter_atlas.construction_map_v11 import (  # noqa: E402
    ConstructionMapV11Error,
    validate_construction_map_v11,
    write_construction_map_v11,
)
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v11(
            ...
            manifest = write_construction_map_v11(
    ...
    except ConstructionMapV11Error as error:
        print(f"construction-map-v11 error: {error}", file=sys.stderr)
        return 2
