#!/usr/bin/env python3
"""Build or offline-validate the corrected Unknown034 delta review v2."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if arguments.validate_only:
        manifest = validate_unknown034_delta_review_v2(
            arguments.output_dir, arguments.definition
        )
    else:
        manifest = write_unknown034_delta_review_v2(
