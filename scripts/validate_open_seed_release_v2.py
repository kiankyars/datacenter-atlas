#!/usr/bin/env python3
"""Rebuild and validate the mixed-schema frozen open-seed v57 twice offline."""
...
from datacenter_atlas.open_seed_release_v2 import validate_open_seed_release_v2
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    manifest = validate_open_seed_release_v2(
