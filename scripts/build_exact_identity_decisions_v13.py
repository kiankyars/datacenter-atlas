#!/usr/bin/env python3
"""Publish or validate exact-identity v13."""
...
from datacenter_atlas.exact_identity_decisions_v13 import (  # noqa: E402
    BUNDLE,
    DEFINITION,
        ...
        if arguments.validate_only:
            ...
            if arguments.definition != DEFINITION or arguments.output_dir != BUNDLE:
                raise ExactIdentityDecisionError(
                    "identity v13 publication paths are fixed and no-replace"
                )
