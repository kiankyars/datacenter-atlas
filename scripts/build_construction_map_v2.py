#!/usr/bin/env python3
"""Build or offline-validate the immutable role-preserving map v2."""
...
from datacenter_atlas.construction_map_v2 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if arguments.validate_only:
            manifest = validate_construction_map_v2(
            ...
            manifest = write_construction_map_v2(
    ...
    except ConstructionMapV2Error as error:
        print(f"construction-map-v2 error: {error}", file=sys.stderr)
        return 2
