...
[eleventh reviewed draft](verified_construction_core/2026-08-20-v0.18-draft-eleventh-reviewed/README.md)
contains 151 sites and is reproducible with `scripts/build_expansion_200_draft.py --batch eleventh-reviewed`.
This is 51 of the requested 100 additions. All earlier checkpoints remain frozen; this checkpoint
