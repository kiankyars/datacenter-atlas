...
[twenty-first reviewed draft](verified_construction_core/2026-08-20-v0.18-draft-twenty-first-reviewed/README.md)
contains 167 sites and is reproducible with `scripts/build_expansion_200_draft.py --batch twenty-first-reviewed`.
This is 67 of the requested 100 additions. All earlier checkpoints remain frozen; this checkpoint
