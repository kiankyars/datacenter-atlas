...
[twenty-second reviewed draft](verified_construction_core/2026-08-20-v0.18-draft-twenty-second-reviewed/README.md)
contains 170 sites and is reproducible with `scripts/build_expansion_200_draft.py --batch twenty-second-reviewed`.
This is 70 of the requested 100 additions. All earlier checkpoints remain frozen; this checkpoint
