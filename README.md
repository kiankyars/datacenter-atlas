...
[Verified Construction Core v0.6 preview](verified_construction_core/2026-08-20-preview-v0.6/),
with its [selection contract and final gates](docs/verified_construction_core.md). It contains 29
recently observed projects grouped into 26 source-scoped physical sites across 17 countries. Four
project rows carry official parcel/survey geometry; 25 use explicitly scoped locators. Nine project
...
not as datasets to add to v0.6.

All five workload observations are machine-labelled `intended`, not operational. Six published
...
| --- | --- | --- |
| Verified construction preview | [v0.6](verified_construction_core/2026-08-20-preview-v0.6/) | 25 portable source, bridge, and cadastral-capture inputs are manifest-bound; the generated preview remains a non-final artifact |
