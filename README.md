...
[thirteenth reviewed draft](verified_construction_core/2026-08-20-v0.18-draft-thirteenth-reviewed/README.md)
contains 156 sites and is reproducible with `scripts/build_expansion_200_draft.py --batch thirteenth-reviewed`.
This is 56 of the requested 100 additions. All earlier checkpoints remain frozen; this checkpoint
