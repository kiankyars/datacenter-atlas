...
[twentieth reviewed draft](verified_construction_core/2026-08-20-v0.18-draft-twentieth-reviewed/README.md)
contains 166 sites and is reproducible with `scripts/build_expansion_200_draft.py --batch twentieth-reviewed`.
This is 66 of the requested 100 additions. All earlier checkpoints remain frozen; this checkpoint
