...
[fourteenth reviewed draft](verified_construction_core/2026-08-20-v0.18-draft-fourteenth-reviewed/README.md)
contains 159 sites and is reproducible with `scripts/build_expansion_200_draft.py --batch fourteenth-reviewed`.
This is 59 of the requested 100 additions. All earlier checkpoints remain frozen; this checkpoint
