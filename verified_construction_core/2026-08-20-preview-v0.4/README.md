# Verified Construction Core v0.4 preview

This tracked preview contains **16 physical sites** and
**17 linked projects** selected from `2026-07-22-open-seed-v97`.
...
that construction occupies the entire parcel. The other 14 use explicitly labelled
