...
for _module_name in (
    ...
    "fuzzy_snapshot",
    "germany_uvp_verbund",
    "global_official_builds_china_gap_20260721",
    "global_official_builds_regional_gap_20260721",
    "global_snapshot",
    "gdelt",
    "iaac_registry",
    ...
    "satellite_queue",
    "satellite_unknown036_continuation_acceptance",
    "satellite_unknown037_continuation_acceptance",
    "satellite_unknown038_continuation_acceptance",
    "scrutica",
    "scrutica_snapshot",
    "service",
